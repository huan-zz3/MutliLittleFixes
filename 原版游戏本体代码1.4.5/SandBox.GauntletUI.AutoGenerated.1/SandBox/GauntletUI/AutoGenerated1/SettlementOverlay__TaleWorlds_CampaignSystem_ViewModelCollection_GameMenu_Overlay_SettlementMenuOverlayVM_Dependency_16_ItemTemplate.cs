...
public class SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate : QuestMarkerBrushWidget
{
	private QuestMarkerBrushWidget _widget;

	private QuestMarkerVM _datasource_Root;

	public SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate(UIContext context)
		: base(context)
	{
	}

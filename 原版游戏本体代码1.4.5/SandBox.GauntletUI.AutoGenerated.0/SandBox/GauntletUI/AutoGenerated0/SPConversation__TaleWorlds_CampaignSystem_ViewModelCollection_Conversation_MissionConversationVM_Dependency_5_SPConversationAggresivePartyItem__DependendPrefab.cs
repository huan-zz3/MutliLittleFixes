...
public class SPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_5_SPConversationAggresivePartyItem__DependendPrefab : Widget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int num = _widget_4.ChildCount - 1; num >= 0; num--)
			{
				...
				((SPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate)_widget_4.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_QuestsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_4.AddChildAtIndex(sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate, e.NewIndex);
			...
			sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_4.GetChild(e.NewIndex);
			((SPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_4.GetChild(e.NewIndex);
			((SPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(ConversationAggressivePartyItemVM newDataSource)
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Quests.Count; i++)
			{
				...
				sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_4.AddChildAtIndex(sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate, i);
				sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate.CreateWidgets();
				sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate.SetIds();
				sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate.SetAttributes();
				sPConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Conversation_MissionConversationVM_Dependency_9_ItemTemplate.SetDataSource(dataSource);

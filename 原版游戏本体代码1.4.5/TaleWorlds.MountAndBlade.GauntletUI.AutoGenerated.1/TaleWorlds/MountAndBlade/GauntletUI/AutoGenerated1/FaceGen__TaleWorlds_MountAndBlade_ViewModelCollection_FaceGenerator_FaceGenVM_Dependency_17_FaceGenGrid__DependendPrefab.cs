...
public class FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_17_FaceGenGrid__DependendPrefab : ListPanel
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_HairTypes != null)
		{
			_datasource_Root_HairTypes.ListChanged -= OnList_datasource_Root_HairTypesChanged;
			for (int num = _widget_1_0_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate)_widget_1_0_0.GetChild(num)).DestroyDataSource();
			}
			_datasource_Root_HairTypes = null;
		}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		{
			RefreshDataSource_datasource_Root_HairTypes(_datasource_Root.HairTypes);
		}
	}

	public void OnList_datasource_Root_HairTypesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		{
			for (int i = 0; i < _datasource_Root_HairTypes.Count; i++)
			{
				FacegenListItemVM bindingObject = _datasource_Root_HairTypes[i];
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			FacegenListItemVM dataSource = (FacegenListItemVM)(generatedWidgetData.Data = _datasource_Root_HairTypes[e.NewIndex]);
			...
			_widget_1_0_0.AddChildAtIndex(faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate, e.NewIndex);
			...
			faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_1_0_0.GetChild(e.NewIndex);
			((FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_1_0_0.GetChild(e.NewIndex);
			((FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(FaceGenVM newDataSource)
	{
		...
		_datasource_Root.PropertyChangedWithDoubleValue += ViewModelPropertyChangedWithDoubleValueListenerOf_datasource_Root;
		_datasource_Root.PropertyChangedWithVec2Value += ViewModelPropertyChangedWithVec2ValueListenerOf_datasource_Root;
		_datasource_Root_HairTypes = _datasource_Root.HairTypes;
		if (_datasource_Root_HairTypes != null)
		{
			_datasource_Root_HairTypes.ListChanged += OnList_datasource_Root_HairTypesChanged;
			for (int i = 0; i < _datasource_Root_HairTypes.Count; i++)
			{
				FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate = new FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate);
				FacegenListItemVM dataSource = (FacegenListItemVM)(generatedWidgetData.Data = _datasource_Root_HairTypes[i]);
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1_0_0.AddChildAtIndex(faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate, i);
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate.CreateWidgets();
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate.SetIds();
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate.SetAttributes();
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_24_ItemTemplate.SetDataSource(dataSource);
	...
	private void RefreshDataSource_datasource_Root_HairTypes(MBBindingList<FacegenListItemVM> newDataSource)
	{
		...
		_datasource_Root_HairTypes = newDataSource;
		_datasource_Root_HairTypes = _datasource_Root.HairTypes;
		if (_datasource_Root_HairTypes != null)
		{
			_datasource_Root_HairTypes.ListChanged += OnList_datasource_Root_HairTypesChanged;

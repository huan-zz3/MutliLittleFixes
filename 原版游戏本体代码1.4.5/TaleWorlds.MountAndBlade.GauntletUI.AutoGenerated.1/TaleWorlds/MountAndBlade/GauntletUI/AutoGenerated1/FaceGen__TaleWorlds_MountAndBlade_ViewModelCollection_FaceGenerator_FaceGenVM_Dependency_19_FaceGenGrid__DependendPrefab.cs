...
public class FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_19_FaceGenGrid__DependendPrefab : ListPanel
{
	...
	public void DestroyDataSource()
	{
		...
		{
			_datasource_Root_TaintTypes.ListChanged -= OnList_datasource_Root_TaintTypesChanged;
			for (int num = _widget_1_0_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate)_widget_1_0_0.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_TaintTypesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		{
			for (int i = 0; i < _datasource_Root_TaintTypes.Count; i++)
			{
				FacegenListItemVM bindingObject = _datasource_Root_TaintTypes[i];
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			FacegenListItemVM dataSource = (FacegenListItemVM)(generatedWidgetData.Data = _datasource_Root_TaintTypes[e.NewIndex]);
			...
			_widget_1_0_0.AddChildAtIndex(faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			...
			((FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_1_0_0.GetChild(e.NewIndex);
			((FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(FaceGenVM newDataSource)
	{
		...
		if (_datasource_Root_TaintTypes != null)
		{
			...
			for (int i = 0; i < _datasource_Root_TaintTypes.Count; i++)
			{
				FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate = new FaceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate);
				FacegenListItemVM dataSource = (FacegenListItemVM)(generatedWidgetData.Data = _datasource_Root_TaintTypes[i]);
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1_0_0.AddChildAtIndex(faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate, i);
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate.CreateWidgets();
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate.SetIds();
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate.SetAttributes();
				faceGen__TaleWorlds_MountAndBlade_ViewModelCollection_FaceGenerator_FaceGenVM_Dependency_26_ItemTemplate.SetDataSource(dataSource);

...
public class MapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_6_SPConversationAggresivePartyItem__DependendPrefab : Widget
{
	...
	public void SetAttributes()
	{
		...
		_widget_0.SuggestedHeight = 49.7f;
		...
		_widget_1.SuggestedHeight = 49.7f;
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int num = _widget_4.ChildCount - 1; num >= 0; num--)
			{
				...
				((MapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate)_widget_4.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_QuestsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_4.AddChildAtIndex(mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate, e.NewIndex);
			...
			mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_4.GetChild(e.NewIndex);
			((MapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_4.GetChild(e.NewIndex);
			((MapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(ConversationAggressivePartyItemVM newDataSource)
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Quests.Count; i++)
			{
				...
				mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_4.AddChildAtIndex(mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate, i);
				mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate.CreateWidgets();
				mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate.SetIds();
				mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate.SetAttributes();
				mapConversation__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapConversation_MapConversationVM_Dependency_10_ItemTemplate.SetDataSource(dataSource);

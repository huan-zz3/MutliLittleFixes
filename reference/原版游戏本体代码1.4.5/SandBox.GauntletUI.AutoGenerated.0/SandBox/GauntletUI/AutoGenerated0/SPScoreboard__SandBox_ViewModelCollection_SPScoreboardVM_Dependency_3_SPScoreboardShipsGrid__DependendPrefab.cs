...
public class SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_3_SPScoreboardShipsGrid__DependendPrefab : Widget
{
		...
		if (_datasource_Root_Attackers != null)
		{
			...
			if (_datasource_Root_Attackers_Ships != null)
			{
				...
				for (int num = _widget_0_0_1.ChildCount - 1; num >= 0; num--)
				{
					...
					((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate)_widget_0_0_1.GetChild(num)).DestroyDataSource();
				}
	...
	public void OnList_datasource_Root_Attackers_ShipsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_1.AddChildAtIndex(sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate, e.NewIndex);
			...
			sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_0_0_1.GetChild(e.NewIndex);
			((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_0_0_1.GetChild(e.NewIndex);
			((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(SPScoreboardVM newDataSource)
	{
		...
		if (_datasource_Root_Attackers_Ships != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Attackers_Ships.Count; i++)
			{
				...
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_1.AddChildAtIndex(sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate, i);
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.CreateWidgets();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetIds();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetAttributes();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetDataSource(dataSource);

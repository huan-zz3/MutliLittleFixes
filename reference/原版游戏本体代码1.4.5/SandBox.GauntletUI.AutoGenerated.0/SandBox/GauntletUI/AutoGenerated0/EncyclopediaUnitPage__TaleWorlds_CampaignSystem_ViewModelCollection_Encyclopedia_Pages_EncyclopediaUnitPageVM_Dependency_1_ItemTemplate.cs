...
public class EncyclopediaUnitPage__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaUnitPageVM_Dependency_1_ItemTemplate : Widget
{
	...
	private void HandleWidgetPropertyChangeOf_widget(string propertyName)
	{
		...
		{
			_datasource_Root.Text = _widget.Sprite.Name;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		else if (propertyName == "Text" && _datasource_Root.Text != null)
		{
			_widget.Sprite = base.Context.SpriteData.GetSprite(_datasource_Root.Text);
		}
	}
